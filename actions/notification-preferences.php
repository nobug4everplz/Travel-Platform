...
$popularDigestEnabled = isset($_POST['popular_digest_enabled']) ? 1 : 0;
$plannerDigestEnabled = $user['role'] === 'planner' && isset($_POST['planner_digest_enabled']) ? 1 : 0;
$winbackEnabled = isset($_POST['winback_enabled']) ? 1 : 0;
